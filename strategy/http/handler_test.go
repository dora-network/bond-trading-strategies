...
func TestHandlerListsStrategies(t *testing.T) {
	...
	require.Len(t, breakout.ConfigFields, 12)
	...
	assert.Equal(t, "min_long_vol_floor", breakout.ConfigFields[7].Name)
	assert.Equal(t, "order_book_id", breakout.ConfigFields[8].Name)
	assert.Equal(t, "tenor", breakout.ConfigFields[9].Name)
	assert.Equal(t, "initial_balance", breakout.ConfigFields[10].Name)
	assert.Equal(t, "leverage", breakout.ConfigFields[11].Name)
